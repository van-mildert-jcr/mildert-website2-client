...
export default function ColourMode() {
  ...
  function showActiveTheme(theme) {
    ...
    if (!activeThemeIcon || !svgOfActiveBtn) return;

    activeThemeIcon.setAttribute("href", svgOfActiveBtn);
  }

  function onToggleClicked(e: React.MouseEvent<HTMLElement>) {
    const to_set_theme = e.currentTarget.getAttribute("data-bs-theme-value");
    setTheme(to_set_theme);
  }
        ...
        <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="bd-theme"
          ...
          <li>
            <button type="button" className="dropdown-item d-flex align-items-center"
                    data-bs-theme-value="light" onClick={onToggleClicked}>
          ...
          <li>
            <button type="button" className="dropdown-item d-flex align-items-center"
                    data-bs-theme-value="dark" onClick={onToggleClicked}>
              <svg className="bi me-2 opacity-50 theme-icon">
                <use href="#moon-stars-fill"></use>
              </svg>
              Dark
          ...
          <li>
            <button type="button" className="dropdown-item d-flex align-items-center active"
                    data-bs-theme-value="auto" onClick={onToggleClicked}>
              <svg className="bi me-2 opacity-50 theme-icon">
